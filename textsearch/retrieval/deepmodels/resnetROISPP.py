...
class ResNetROISPP(nn.Module):
    def __init__(self, block, num_blocks, spp_level, num_classes=10):
        super(ResNetROISPP, self).__init__()
        self.in_planes = 64
        ...
        # self.fc3 = nn.Linear(2048,num_classes)    #Removed for E2E
...
def ResNetROI18SPP(spp_level,num_classes=10):
    return ResNetROISPP(PreActBlock, [2,2,2,2], spp_level,num_classes)

def ResNetROI34SPP(spp_level,num_classes=10):
    return ResNetROISPP(BasicBlock, [3,4,6,3], spp_level, num_classes)

def ResNetROI50SPP(spp_level):
    return ResNetROISPP(Bottleneck, [3,4,6,3], spp_level)

def ResNetROI101SPP(spp_level):
    return ResNetROISPP(Bottleneck, [3,4,23,3], spp_level)

def ResNetROI152SPP(spp_level):
    return ResNetROISPP(Bottleneck, [3,8,36,3],spp_level)
